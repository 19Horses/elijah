...
// On initial load, the view starts zoomed out to this fraction of the fit
// view's zoom (same centre) and eases in to it, rather than appearing
// already framed.
export const ENTRANCE_ZOOM_START_FACTOR = 0.4;
